...
urlpatterns = [
    ...
    path('api/v1/auth/jwt/create/', extend_schema_view(post=extend_schema(tags=["JWT"]))(TokenObtainPairView.as_view(serializer_class=CustomTokenObtainPairSerializer)), name='token_obtain_pair'),
